...
public class SignIn extends AppCompatActivity implements View.OnClickListener {
    ...
    CheckBox checkDonor;
    String account="recepient";
    private String password;
    android.support.v7.app.AlertDialog alertDialog,alertDialog2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkDonor=(CheckBox)findViewById(R.id.check_donor);
        checkDonor.setOnClickListener(new View.OnClickListener() {
                    ...
                    if (error) {//When response returns error
                        ...
                        if(account.equals("donor"))
                        {
                            Intent intent = new Intent(
                                    getBaseContext(),DonorActivity.class);
                            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
                            intent.putExtra("access","signin");
                            startActivity(intent);


                        }else if(account.equals("recepient"))
                        {Intent intent = new Intent(

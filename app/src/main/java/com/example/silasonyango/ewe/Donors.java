...
public class Donors extends Fragment {
   ...
   public  boolean internet;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      //  net=(TextView) v.findViewById(R.id.internet);
    ...
    private void getData(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST,Config.get_donors_url, new Response.Listener<String>() {
            @Override
    ...
    private void showGrid(JSONArray jsonArray){
        ...
        RecyclerViewAdapterTwo rcAdapter = new RecyclerViewAdapterTwo(getActivity(),FullNames,Genders,BloodGroups,PhoneNumbers,Counties,Cities,ids,ResidentialAddresses,BookedTimes,emails,Periods);

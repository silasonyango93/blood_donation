...
public class Appointments extends Fragment {
    ...
    private void getData(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST,Config.get_my_appointments, new Response.Listener<String>() {
            @Override
    ...
    private void showGrid(JSONArray jsonArray){
        ...
        RecyclerViewAdapterAppointments rcAdapter = new RecyclerViewAdapterAppointments(getActivity(),FullNames,Genders,BloodGroups,PhoneNumbers,Counties,Cities,ids,ResidentialAddresses,BookedTimes,emails,Periods);
